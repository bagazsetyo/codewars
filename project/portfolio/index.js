!(function (e) {
  ...
  28: function (e, t, n) {
    ...
    var P = new ((o = Object(a.a)({ x: 2, y: 3 }, 0.05)),
      ...
      S = new l.a("Shooting Stars", { color: "#dc2c5a", size: b.a.isMobile ? 0.4 : 0.8 });
    (S.position.x -= 0.5 * S.basePosition), P.add(S);
    var _ = { width: 0.05, nbrOfPoints: 1, turbulence: new i.Vector3(), orientation: new i.Vector3(-1, -1, 0), color: new i.Color("#e6e0e3") },
      x = new ((function (e) {
        function t() {
          return O(this, t), w(this, g(t).apply(this, arguments));
        }
          ...
          (o = [
            {
              key: "addLine",
              value: function () {
                h(g(t.prototype), "addLine", this).call(this, { length: Object(y.a)(5, 10), visibleLength: Object(y.a)(0.05, 0.2), speed: Object(y.a)(0.01, 0.02), position: new i.Vector3(Object(y.a)(-4, 8), Object(y.a)(-3, 5), Object(y.a)(-2, 5)) });
              },
            },
          ]) && d(n.prototype, o),
          r && d(n, r),
    ...
    M.to(".overlay", 2, { opacity: 0 }),
      ...
      b.a.onHide(function (e) {
        var t = new u.b();
        t.to(P.lookAt, 2, { y: -6, ease: Power3.easeInOut }), t.add(S.hide, 0), t.add(x.stop), t.to(".overlay", 0.5, { autoAlpha: 1, onComplete: e }, "-=1.5");
      });
  },
  29: function (e, t, n) {},
});
